...
n, k = 256, 3            # k changed from 3 to 5 for 256-bit security
q = 7681 # change to 10753
d_v=5 
d_u=11
...
"""
128-bit security:
Kyber-CPA tail-bound: 1887
is q=7681 enough: True
Rest: 33.25
log2 of k1*n * tail probability at (q/4): -132.6049205962225

256-bit security
Kyber-CPA tail-bound: 2578
is q=10753 enough: True
Rest: 110.25
log2 of k1*n * tail probability at (q/4): -139.6369522196431
"""
